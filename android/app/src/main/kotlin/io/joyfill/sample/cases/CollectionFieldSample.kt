...
internal fun CollectionFieldSample() = ThemedSample {
    val document = remember {
        buildDocument {
            ...
            collection("School Data") {
                table("Schools", id = "school", children = listOf("Teachers")) {
    ...
    val editor = rememberDocumentEditor(document) { (changelogs, document) ->
        println("changeEvent => ${changelogs.map { it.toMap() }}")
